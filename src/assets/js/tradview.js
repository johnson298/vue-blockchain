    ...
    getOverrides(theme = 'Light'){
        var themes = {
            ...
            "Dark": {
                ...
                volumeBuy: "rgba(32, 240, 140, 1)",
                volumeSell: "rgba(250, 56, 56, 1)",

                volumeSellR: "rgba(250, 56, 56,.3)",
                volumeBuyR: "rgba(32, 240, 140,.3)",
                background: "#19212D",
                candleStyleUpColor: '#4181FF',
                verColor: 'rgba(48, 59, 77,.8)',
                horColor: 'rgba(48, 59, 77,.8)',
